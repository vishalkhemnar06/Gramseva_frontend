...
import { FiTrash2, FiUser, FiCalendar, FiAward } from 'react-icons/fi';
...
const SchemeCard = ({
    ...
    const handleDeleteClick = (e) => {
        e.stopPropagation();
        onDelete?.(scheme._id, scheme.heading);
    };
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex flex-col gap-1 text-xs text-gray-500">
                            <span className="flex items-center gap-2">
                                ...
                                <span>{scheme.addedBy?.name || 'Admin'}</span>
                            </span>
                            <span className="flex items-center gap-2">
                                <FiCalendar size={12} className="text-gray-400" />
                                <span>{formatDate(scheme.addedAt || scheme.createdAt)}</span>
                            </span>
                        </div>
